...
The hard part is that a simple "copy, then check" implementation can look
reasonable in a small sanity check while still letting an invalid snapshot
escape under real concurrency.
