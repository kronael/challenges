...
CC       ?= cc
CFLAGS   ?= -std=c11 -O2 -g -Wall -Wextra -D_POSIX_C_SOURCE=200809L
CPPFLAGS += -I. -I$(C_IO_DIR)
LDLIBS   ?=
TIMEOUT  ?= 5
LARGE    := $(wildcard ../cases/??_large_*.in)
C_IO_MAKEFILE := $(lastword $(MAKEFILE_LIST))
...
main: $(C_IO_DIR)/main.c solution.c $(C_IO_HEADERS)
	$(CC) $(CPPFLAGS) $(CFLAGS) -o $@ $(C_IO_DIR)/main.c solution.c $(LDLIBS)

run_tests: $(C_IO_DIR)/test.c solution.c $(C_IO_HEADERS)
	$(CC) $(CPPFLAGS) $(CFLAGS) -o $@ $(C_IO_DIR)/test.c solution.c $(LDLIBS)
...
lint:
	$(CC) $(CPPFLAGS) $(CFLAGS) -Wpedantic -Wshadow -Wstrict-prototypes -Werror \
