## T1 — Python case harnesses pass when no cases are collected (2026-07-14, open)
...
## T2 — Reference tests ignore failed subprocess exit status (2026-07-14, open)
...
## T3 — Dynamic range Go tests fabricate expectations after I/O errors (2026-07-14, open)
